...
using ChummerDataViewer.Backend.Overrides;
...
public static class XmlLoader
{
    ...
    public static async Task LoadAllAsync<T>(HttpClient client, ILogger logger) where T : ICreatable
    {
        ...
        await CreateAllAsync(logger, iCreatableObjects);
    }

    private static async Task CreateAllAsync(ILogger logger, List<ICreatable> iCreatableObjects)
    {
